...
-- Q1) Find all current or previous employees with first names 'Irena', 'Vidya', or 'Maya' using IN. What is the employee number of the top three results?
describe employees;
...
-- Q2) Find all current or previous employees with first names 'Irena', 'Vidya', or 'Maya', as in Q2, but use OR instead of IN. What is the employee number of the top three results? Does it match the previous question?
select emp_no, first_name from employees 
where first_name in ('Irena','Vidya') or first_name='Maya';
-- A: it's the same output as Q1

-- Q3) Find all current or previous employees with first names 'Irena', 'Vidya', or 'Maya', using OR, and who is male. What is the employee number of the top three results?
select emp_no, first_name
from employees
where first_name in ('Irena', 'Vidya', 'Maya')
and gender='M';

-- A: 10200, 10397, 10821 emp_no
